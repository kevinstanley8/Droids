...
Imports System.IO
Module Module1
    Public NoOfProducts As Integer = 5
    Public NoOfBerthArms As Integer = 4
    Public NoOfShips As Integer = 20
    Public Const PVRVol = 1
    Public Const PVRTmp = 2
    Public Const PVRPrs = 3
    Public Const PVRDen = 4
    Public Const PVRTmr = 5
    Public Const PVRState = 6
    Public Const PVRRun = 7
    Public Const PVRVolMStart = 8
    Public Const PVRVolPStart = 9
    Public Const PVRVolMStop = 10
    Public Const PVRVolPStop = 11
    Public Const PVRCorr = 12
